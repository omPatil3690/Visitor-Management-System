...
export function UserManagement() {
  ...
  const users = [
    { id: 1, name: 'John Doe', email: 'john@example.com', role: 'resident', status: 'active' },
    { id: 2, name: 'Jane Smith', email: 'jane@example.com', role: 'guard', status: 'active' },
    { id: 3, name: 'Bob Wilson', email: 'bob@example.com', role: 'visitor', status: 'inactive' },
  ];
